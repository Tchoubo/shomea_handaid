...
import 'package:shomea_handaid/inscription/enregistrementVolontaire.dart';
...
class ShomeaHandAidVolontaire extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePageVolontaire(title: 'Flutter Demo Home Pagse'),
    );
  }
}
...
class MyHomePageVolontaire extends StatefulWidget {
  MyHomePageVolontaire({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  _MyHomePageVolontaireState createState() => _MyHomePageVolontaireState();
}

class _MyHomePageVolontaireState extends State<MyHomePageVolontaire> {

  TextEditingController phoneNumberController = TextEditingController();
  TextEditingController passwordController = TextEditingController();
  bool _isObscure = true, isLoading = false;

  void loginVolontaire(String phoneNumber, password) async{
    try{
            ...
            Container(
                ...
                child: Row(
                  children: [
                    ...
                    InkWell(
                      onTap: (){
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => MyRegisterVolontaire(title: '',)));
                      },
                      child: Text('REGISTER',
                        style: TextStyle(
                            color: Colors.grey,
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: new InkWell(
                      onTap: (){
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => MyAlert(title: '',)));
                        //loginVolontaire(phoneNumberController.text.toString(), passwordController.text.toString());
                      },
                      child: new Container(
                        height: hauteur/15,
