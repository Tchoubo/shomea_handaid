...
import 'package:shomea_handaid/homePagePotentiel.dart';
...
class EnregistrementPotentiel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyRegisterPontentiel(title: 'Flutter Demo Home Pagse'),
    );
  }
}
...
class MyRegisterPontentiel extends StatefulWidget {
  MyRegisterPontentiel({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  _MyRegisterPontentielState createState() => _MyRegisterPontentielState();
}

class _MyRegisterPontentielState extends State<MyRegisterPontentiel> {
  ...
  void registerPotentiel(String phoneNumber, String nameOfCompany, String password, String email) async{
    try{
                ...
                child: Row(
                  children: [
                    GestureDetector(
                        onTap: (){
                          setState(() {
                            Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => new MyHomePagePotentiel(title: "")));
                          });
                        },
